...
export default function OrderSummeryCard() {
  return (
    <div className="w-full flex flex-col md:flex-row gap-3 md:gap-0 justify-between md:items-center my-8">
      <div className="w-full pl-4 max-w-[9rem]">
        <p className="text-gray-500 text-sm uppercase">ORDER NUMBER:</p>
        <p className="text-xl font-bold">5464</p>
      </div>
      <div className="hidden md:block w-[1px] h-[2.5rem] bg-gray-400"></div>
